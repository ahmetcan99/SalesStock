...
namespace SalesStock.Application.Features.Customers.Validators
{
    public class UpdateCustomerDTOValidator : AbstractValidator<UpdateCustomerDTO>
    {
        ...
        private async Task<bool> BeUniqueCode(UpdateCustomerDTO dto, string code, CancellationToken cancellationToken)
        {
            return !await _customerRepository.CodeExistsForOtherCustomerAsync(dto.Id, code);
        }
    }
}
